...
#define BSP_CFG_STARTUP_DISABLE (1)
...
*/
#if defined(CONFIG_BOARD_RSK_RX65N_2MB)
/* RSK processor: R5F565NEDD*FC* */
   #define BSP_CFG_MCU_PART_PACKAGE        (0x0)
#elif defined(CONFIG_BOARD_RTB_RX65N)
/* Target board processor: R5F565NEDD*FP* */
...
*/
#if defined(CONFIG_BOARD_RSK_RX65N_2MB)
/* RSK processor: R5F565NE*D*DFC */
   #define BSP_CFG_MCU_PART_ENCRYPTION_INCLUDED   (false)
#elif defined(CONFIG_BOARD_RTB_RX65N)
/* Target board processor: R5F565NE*D*DFP */
   #define BSP_CFG_MCU_PART_ENCRYPTION_INCLUDED   (false)
#else
   #error Unknown processor type.
#endif
...
*/
#if defined(CONFIG_BOARD_RSK_RX65N_2MB)
/* RSK processor: R5F565N*E*DDFC */
   #define BSP_CFG_MCU_PART_MEMORY_SIZE    (0xE)
#elif defined(CONFIG_BOARD_RTB_RX65N)
/* Target board processor: R5F565N*E*DDFP */
   #define BSP_CFG_MCU_PART_MEMORY_SIZE    (0xE)
#else
   #error Unknown processor type.
#endif
...
/* This macro lets other modules no if a RTOS is being used.
   ...
   5 = Zephyr RTOS (TODO: this currently has the same effect as 0)
*/
...
*/
#define BSP_CFG_USER_LOCKING_TYPE       struct k_sem
