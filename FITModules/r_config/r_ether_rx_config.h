 ...
 */
#define ETHER_CFG_MODE_SEL	DT_PROP(ETH0, interface_mode)
 ...
 */
#define ETHER_CFG_CH0_PHY_ADDRESS	DT_PROP(ETH0, phy_address)
 ...
 */
#define ETHER_CFG_USE_LINKSTA	DT_PROP(ETH0, linksta)
